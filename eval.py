...
parser.add_argument('--related_w_h5', type=str,
                    default=data_dir + dataset + '_retr10_words300_word_ids.h5',  # '/content/data/template_newf_retr10_words300_time_label.h5'
...
parser.add_argument('--pointer_matching', type=bool, default=True, help='whether to use word-level match')
parser.add_argument('--pointer_matching_weight', type=float, default=0.2, help='weight for word-level matching loss')


parser.add_argument('--word_mask', type=bool, default=True, help='whether to mask the padding in word-level attention')
